<ul class="nav">
          ...
          <li class="nav-item {{ setActive(['anggota*', 'film*', 'user*']) }}">
            <a class="nav-link " data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-content-copy"></i>
              <span class="menu-title">Data Master</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ setShow(['anggota*', 'film*', 'user*']) }}" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link {{ setActive(['anggota*']) }}" href="{{route('anggota.index')}}">Data Member</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ setActive(['film*']) }}" href="{{route('film.index')}}">Data Movie List</a>
                </li>
                 <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-laporan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('laporan/trs')}}">Transaction Report</a>
                </li>
                <!--
                <li class="nav-item">
                  <a class="nav-link" href="">Laporan Aselole</a>
                </li>
                -->
                 <li class="nav-item">
                  <a class="nav-link" href="{{url('laporan/film')}}">Report Movie List</a>
                </li>
              </ul>
            </div>
          </li>
