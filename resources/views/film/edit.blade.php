...
<form action="{{ route('film.update', $data->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
<div class="row">
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit Movie List <b>{{$data->judul}}</b> </h4>
                      <?php //print_r($data->judul);die();?>
                      <?php //dd($data);?>
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('movie_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="movie_id" type="text" class="form-control" name="movie_id" value="{{ $data->movie_id }}" required>
                        ...
                        <div class="form-group{{ $errors->has('filmby') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="filmby" type="text" class="form-control" name="filmby" value="{{ $data->filmby }}" required>
                        ...
                        <div class="form-group{{ $errors->has('studio') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="studio" type="text" class="form-control" name="studio" value="{{ $data->studio }}" required>
                        ...
                        <div class="form-group{{ $errors->has('tahun') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tahun" type="number" maxlength="4" class="form-control" name="tahun" value="{{ $data->tahun }}" required>
                                @if ($errors->has('tahun'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('stok') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="stok" type="number" maxlength="4" class="form-control" name="stok" value="{{ $data->stok }}" required>
                                @if ($errors->has('stok'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('sewa') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="sewa" type="number" maxlength="4" class="form-control" name="sewa" value="{{ $data->sewa }}" required>
                                @if ($errors->has('sewa'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('jual') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jual" type="number" maxlength="4" class="form-control" name="jual" value="{{ $data->jual }}" required>
                                @if ($errors->has('jual'))
                                    <span class="help-block">
